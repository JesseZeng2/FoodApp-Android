...
public class DetailsDrinksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_details_drinks);

        mainImage = findViewById(R.id.DrinksImage);
        name = findViewById(R.id.DrinksName);
        description = findViewById(R.id.DrinksText1);
        price = findViewById(R.id.DrinksPrice);
    ...
    // get image name and description of corresponding Drinks food
