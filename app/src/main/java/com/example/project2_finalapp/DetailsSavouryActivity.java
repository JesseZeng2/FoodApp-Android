...
public class DetailsSavouryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_details_savoury);

        mainImage = findViewById(R.id.SavouryImage);
        name = findViewById(R.id.SavouryName);
        description = findViewById(R.id.SavouryText1);
        price = findViewById(R.id.SavouryPrice);
    ...
    // get image name and description of corresponding savoury food
